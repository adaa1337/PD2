...
<div class="container">
    <h1 style="color:white;" class="h3 text-center my-4">Virtus Pro sastavs</h1>
    <div class="row">
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/jame.png">
                <img class="img-fluid" src="images/jame.png" alt="">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/sanji.png">
                <img class="img-fluid" src="images/sanji.png" alt="...">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/adrenvp.png">
                <img class="img-fluid" src="images/adrenvp.png" alt="...">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/qikert.png">
                <img class="img-fluid" src="images/qikert.png" alt="...">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/buster.png">
                <img class="img-fluid" src="images/buster.png" alt="...">
            </a>
        </div>
