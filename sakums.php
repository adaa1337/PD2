...
<div class="container">
    <h1 style="color:white;" class="h3 text-center my-4">Avangar pedejais sastavs</h1>
    <div class="row">
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/jame.jpeg">
                <img class="img-fluid" src="images/jame.jpeg" alt="">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/sanji.jpeg">
                <img class="img-fluid" src="images/sanji.jpeg" alt="...">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/adren.jpeg">
                <img class="img-fluid" src="images/adren.jpeg" alt="...">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/qikert.jpeg">
                <img class="img-fluid" src="images/qikert.jpeg" alt="...">
            </a>
        </div>
        <div class="col-lg-3 col-md-4 col-6 thumb">
            <a data-fancybox="gallery" href="images/buster.jpeg">
                <img class="img-fluid" src="images/buster.jpeg" alt="...">
            </a>
        </div>
